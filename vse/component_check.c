...
static const u8 _golden_components[VSE_NUM_COMPONENTS][HMAC_SIZE] = {
    /* [0] .text golden HMAC — re-derived after 2 MB section alignment (audit #7b) */
    {
        0x66, 0x3f, 0xfb, 0x16, 0xfa, 0xdf, 0x21, 0x60,
        0x81, 0x1c, 0x7e, 0xf1, 0x83, 0x7b, 0x47, 0x0f,
        0x24, 0x3c, 0x14, 0x35, 0x1e, 0xea, 0x96, 0x6f,
        0x83, 0xff, 0xee, 0xba, 0x63, 0x48, 0x56, 0x04,
    },

#if VSE_NUM_COMPONENTS > 1
    /* [1] .rodata golden HMAC — unchanged; two-segment hash skips golden table */
    {
